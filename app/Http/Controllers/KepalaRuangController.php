...
/**
 * Controller untuk Kepala Ruang (IRNA - Instalasi Rawat Inap)
 * 
 * Kepala Ruang memiliki hak akses yang sama dengan Admin untuk:
 * - Input permintaan baru
 * - Melihat semua permintaan di ruangannya
...
class KepalaRuangController extends Controller
{
    ...
    /**
     * Display a listing of permintaan untuk ruangan ini
     */
    public function index(Request $request)
    {
        ...
        return Inertia::render('KepalaRuang/Index', [
    ...
    {
        return Inertia::render('KepalaRuang/Create');
    }
    ...
    public function show(Permintaan $permintaan)
    {
        ...
        return Inertia::render('KepalaRuang/Show', [
    ...
    public function edit(Permintaan $permintaan)
    {
        ...
        return Inertia::render('KepalaRuang/Edit', [
            'permintaan' => $permintaan,
        ]);
    }
    ...
    public function tracking(Permintaan $permintaan)
    {
        ...
        return Inertia::render('KepalaRuang/Tracking', [
            'permintaan' => $permintaan,
            'timeline' => $timeline,
            'progress' => $progress,
        ]);
    ...
    public function cetakNotaDinas(Permintaan $permintaan)
    {
        ...
        return Inertia::render('KepalaRuang/CetakNotaDinas', [
            'permintaan' => $permintaan,
        ]);
    }
    ...
    public function lihatLampiran(NotaDinas $notaDinas)
    {
        ...
        return Inertia::render('KepalaRuang/LampiranNotaDinas', [
            'notaDinas' => $notaDinas,
        ]);
    }
}
