...
class StaffPerencanaanController extends Controller
{
    ...
    public function show(Permintaan $permintaan)
    {
        ...
        // Cek otorisasi - pastikan permintaan ditujukan ke Staff Perencanaan
        ...
        if (!$hasValidNotaDinas) {
            abort(403, 'Permintaan ini belum melalui proses approval yang lengkap dari Direktur/Wakil Direktur.');
        }
    ...
    public function createPerencanaan(Permintaan $permintaan)
    {
        ...
        // Cek otorisasi
        if ($permintaan->pic_pimpinan !== 'Staff Perencanaan' && $permintaan->pic_pimpinan !== $user->nama) {
            abort(403, 'Anda tidak memiliki akses untuk membuat perencanaan permintaan ini.');
        }
    ...
    public function uploadDokumen(Permintaan $permintaan)
    {
        ...
        // Cek otorisasi
        if ($permintaan->pic_pimpinan !== 'Staff Perencanaan' && $permintaan->pic_pimpinan !== $user->nama) {
            abort(403, 'Anda tidak memiliki akses untuk upload dokumen permintaan ini.');
        }
    ...
    public function downloadDokumen(Permintaan $permintaan, DokumenPengadaan $dokumen)
    {
        ...
        // Cek otorisasi
        if ($permintaan->pic_pimpinan !== 'Staff Perencanaan' && $permintaan->pic_pimpinan !== $user->nama) {
            abort(403, 'Anda tidak memiliki akses untuk download dokumen permintaan ini.');
        }
        
        // Cek apakah dokumen milik permintaan ini
        if ($dokumen->permintaan_id !== $permintaan->permintaan_id) {
            abort(403, 'Dokumen tidak sesuai dengan permintaan.');
        }
    ...
    public function deleteDokumen(Permintaan $permintaan, DokumenPengadaan $dokumen)
    {
        ...
        // Cek otorisasi
        if ($permintaan->pic_pimpinan !== 'Staff Perencanaan' && $permintaan->pic_pimpinan !== $user->nama) {
            abort(403, 'Anda tidak memiliki akses untuk menghapus dokumen permintaan ini.');
        }
