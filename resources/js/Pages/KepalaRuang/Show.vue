            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex gap-3">
                    ...
                    <a
                        ...
                        :href="route('kepala-ruang.cetak-nota-dinas', permintaan.permintaan_id)"
                        target="_blank"
                        ...
                        <div v-for="nota in permintaan.nota_dinas" :key="nota.nota_id" class="mb-4 last:mb-0">
                            <dl class="grid grid-cols-1 md:grid-cols-2 gap-4 bg-gray-50 p-4 rounded-lg border border-gray-200">
                                ...
                                <div v-if="nota.lampiran" class="md:col-span-2">
                                    ...
                                    <dd>
                                        <a 
                                            :href="route('kepala-ruang.lampiran', nota.nota_id)" 
                                            target="_blank" 
...
const deletePermintaan = () => {
    ...
    deleting.value = true;
    router.delete(route('kepala-ruang.destroy', props.permintaan.permintaan_id), {
        onSuccess: () => {
