...
<template>
    <Head title="Dashboard Pengadaan" />
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-sm font-medium text-gray-600">Belum Pengadaan</p>
                                <p class="text-3xl font-bold text-yellow-600">{{ stats.belum_kso }}</p>
                            </div>
                    ...
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-sm font-medium text-gray-600">Sedang Pengadaan</p>
                                <p class="text-3xl font-bold text-blue-600">{{ stats.aktif }}</p>
                            </div>
                            <div class="p-3 bg-blue-100 rounded-full">
                                <svg class="w-8 h-8 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <div class="flex justify-between items-center mb-4">
                            ...
                            <Link :href="route('pengadaan.index')" class="text-blue-600 hover:text-blue-800 text-sm font-medium">
                                Lihat Semua →
                            </Link>
                        </div>
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    <tr v-for="permintaan in recentPermintaans" :key="permintaan.permintaan_id">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span v-if="permintaan.has_pengadaan" class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800">
                                                Sudah Ada Pengadaan
                                            </span>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <Link :href="route('pengadaan.show', permintaan.permintaan_id)" 
