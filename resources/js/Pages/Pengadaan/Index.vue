...
// Apply filters
const applyFilters = () => {
    router.get(route('pengadaan.index'), {
        search: search.value,
        status: status.value,
        bidang: bidang.value,
    }, {
...
<template>
    <Head title="Daftar Permintaan Pengadaan" />
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                <thead class="bg-gray-50">
                                    <tr>
                                        ...
                                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Status Pengadaan</th>
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    <tr v-for="permintaan in permintaans.data" :key="permintaan.permintaan_id" class="hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                            ...
                                            <Link v-if="!permintaan.has_pengadaan" 
                                                  :href="route('pengadaan.create', permintaan.permintaan_id)" 
                        ...
                        <div v-else class="text-center py-12">
                            ...
                            <p class="mt-1 text-sm text-gray-500">Belum ada permintaan untuk Bagian Pengadaan.</p>
                        </div>
                    </div>
                </div>
