                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                    <div class="p-6 bg-gradient-to-r from-indigo-600 to-indigo-700 text-white">
                        ...
                        <p class="text-xs opacity-75 mt-1">
                            Approval Level 3 - Supervisi Eksekutif
                        </p>
                    </div>
                </div>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 border-b border-gray-200">
                        <div class="flex items-center justify-between">
                            ...
                            <Link :href="route('wakil-direktur.index')" class="text-sm text-indigo-600 hover:text-indigo-800 font-medium">
                                Lihat Semua →
                            </Link>
                        </div>
                    </div>
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <div class="w-full bg-gray-200 rounded-full h-2">
                                                <div class="bg-indigo-600 h-2 rounded-full transition-all" :style="{ width: permintaan.progress + '%' }"></div>
                                            </div>
                                        </div>
                                    </div>
                                    
                                    <Link :href="route('wakil-direktur.show', permintaan.permintaan_id)"
                                        class="ml-4 px-4 py-2 bg-indigo-600 text-white text-sm rounded-lg hover:bg-indigo-700 transition-colors">
                                        Review
                                    </Link>
                                </div>
                            </div>
