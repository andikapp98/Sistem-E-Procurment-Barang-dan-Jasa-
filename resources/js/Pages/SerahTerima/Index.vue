...
// Apply filters
const applyFilters = () => {
    router.get(route('serah-terima.index'), {
        search: search.value,
        status: status.value,
        bidang: bidang.value,
    }, {
...
<template>
    <Head title="Daftar Nota Penerimaan" />
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <div v-if="penerimaans.data && penerimaans.data.length > 0" class="overflow-x-auto">
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    <tr v-for="permintaan in penerimaans.data" :key="permintaan.permintaan_id" class="hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                            ...
                                            <Link v-if="!permintaan.has_kso" 
                                                  :href="route('serah-terima.create', permintaan.permintaan_id)" 
                            ...
                            <div class="mt-4 flex justify-between items-center">
                                <div class="text-sm text-gray-700">
                                    Menampilkan {{ penerimaans.from }} - {{ penerimaans.to }} dari {{ penerimaans.total }} data
                                </div>
                                <div class="flex space-x-2">
                                    <Link v-for="link in penerimaans.links" 
                                          :key="link.label"
                                          :href="link.url || '#'"
                                          :class="{
                        ...
                        <div v-else class="text-center py-12">
                            ...
                            <p class="mt-1 text-sm text-gray-500">Belum ada permintaan untuk Serah Terima.</p>
                        </div>
                    </div>
                </div>
