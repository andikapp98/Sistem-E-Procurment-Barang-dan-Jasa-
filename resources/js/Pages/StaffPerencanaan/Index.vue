                                        ...
                                        <tr v-for="permintaan in permintaans.data" :key="permintaan.permintaan_id" 
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                <div class="flex gap-2 justify-end">
                                                    ...
                                                    <Link v-if="permintaan.status === 'disetujui'"
                                                        :href="route('staff-perencanaan.scan-berkas', permintaan.permintaan_id)"
                                                        class="inline-flex items-center px-3 py-1 bg-blue-600 text-white text-xs font-medium rounded-lg hover:bg-blue-700 transition">
