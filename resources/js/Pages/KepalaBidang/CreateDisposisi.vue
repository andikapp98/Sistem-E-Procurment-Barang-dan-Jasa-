    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center justify-between">
                ...
                <Link :href="route('kepala-bidang.show', permintaan.permintaan_id)" class="text-sm text-gray-600 hover:text-gray-900">
                    ← Kembali
                </Link>
            </div>
        </template>
...
const submit = () => {
    router.post(route('kepala-bidang.disposisi.store', props.permintaan.permintaan_id), form.value);
};
</script>
