    ...
    <AuthenticatedLayout>
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                ...
                <div v-if="permintaan.status === 'proses' || permintaan.status === 'disetujui'" class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        ...
                        <div v-if="isDisposisiDariDirektur" class="bg-green-50 border border-green-200 rounded-lg p-4 mb-4">
                            <p class="text-sm text-green-800">
                                ...
                                <strong>Disposisi dari Direktur:</strong> Permintaan sudah disetujui Direktur. Silakan teruskan ke Staff Perencanaan.
                            </p>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <!-- Reject Button - Hanya untuk permintaan baru -->
                            <button
                                v-if="!isDisposisiDariDirektur"
                            ...
                            <!-- Revisi Button - Hanya untuk permintaan baru -->
                            <button
                                v-if="!isDisposisiDariDirektur"
        ...
        <Modal :show="showApproveModal" @close="showApproveModal = false">
            <div class="p-6">
                ...
                <div :class="isDisposisiDariDirektur ? 'bg-green-50 border-green-200' : 'bg-purple-50 border-purple-200'" class="border rounded-lg p-4 mb-4">
                    <p class="text-sm" :class="isDisposisiDariDirektur ? 'text-green-800' : 'text-purple-800'">
                        <svg class="w-5 h-5 inline-block mr-2" :class="isDisposisiDariDirektur ? 'text-green-600' : 'text-purple-600'" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path>
                        </svg>
                        <span v-if="isDisposisiDariDirektur">
                            Permintaan sudah disetujui Direktur. Akan diteruskan ke <strong>Staff Perencanaan</strong> untuk perencanaan pengadaan.
                        </span>
                        <span v-else>
                            Permintaan akan diteruskan ke <strong>Direktur</strong> untuk approval tertinggi.
                        </span>
                    </p>
                </div>
