            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex gap-3">
                    ...
                    <a
                        ...
                        :href="route('kepala-poli.cetak-nota-dinas', permintaan.permintaan_id)"
                        target="_blank"
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex gap-3">
                                ...
                                <Link
                                    ...
                                    :href="route('kepala-poli.edit', permintaan.permintaan_id)"
                        ...
                        <div v-for="nota in permintaan.nota_dinas" :key="nota.nota_id" class="mb-4 last:mb-0">
                            <dl class="grid grid-cols-1 md:grid-cols-2 gap-4 bg-gray-50 p-4 rounded-lg border border-gray-200">
                                ...
                                <div v-if="nota.lampiran" class="md:col-span-2">
                                    ...
                                    <dd>
                                        <a 
                                            :href="route('kepala-poli.lampiran', nota.nota_id)" 
                                            target="_blank" 
...
const deletePermintaan = () => {
    ...
    deleting.value = true;
    router.delete(route('kepala-poli.destroy', props.permintaan.permintaan_id), {
        onSuccess: () => {
